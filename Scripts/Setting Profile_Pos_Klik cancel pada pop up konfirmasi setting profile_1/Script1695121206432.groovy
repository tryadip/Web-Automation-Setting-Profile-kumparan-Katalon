...
String bio = GlobalVariable.biography
...
WebUI.delay(2)
WebUI.setText(findTestObject("TxtField/Field_Biography"), bio)
...
WebUI.click(findTestObject("Button/btn_Save"))
WebUI.delay(2)
WebUI.click(findTestObject("Popup/btn_Batal"))